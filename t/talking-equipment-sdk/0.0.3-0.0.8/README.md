# Comparing `tmp/talking_equipment_sdk-0.0.3.tar.gz` & `tmp/talking_equipment_sdk-0.0.8.tar.gz`
...
## Comparing `talking_equipment_sdk-0.0.3.tar` & `talking_equipment_sdk-0.0.8.tar`
...
### Comparing `talking_equipment_sdk-0.0.3/setup.py` & `talking_equipment_sdk-0.0.8/setup.py`
...
### Comparing `talking_equipment_sdk-0.0.3/talking_equipment/api/handlers.py` & `talking_equipment_sdk-0.0.8/talking_equipment/api/handlers.py`

 * *Files identical despite different names*

### Comparing `talking_equipment_sdk-0.0.3/talking_equipment/api/requests.py` & `talking_equipment_sdk-0.0.8/talking_equipment/api/requests.py`

 * *Files identical despite different names*

### Comparing `talking_equipment_sdk-0.0.3/talking_equipment/data/control/tests.py` & `talking_equipment_sdk-0.0.8/talking_equipment/data/control/tests.py`

 * *Files identical despite different names*

### Comparing `talking_equipment_sdk-0.0.3/talking_equipment/data/entities.py` & `talking_equipment_sdk-0.0.8/talking_equipment/data/entities.py`

 * *Files identical despite different names*

### Comparing `talking_equipment_sdk-0.0.3/talking_equipment/data/temperature/entities.py` & `talking_equipment_sdk-0.0.8/talking_equipment/data/temperature/entities.py`

 * *Files identical despite different names*

### Comparing `talking_equipment_sdk-0.0.3/talking_equipment/data/temperature/tests.py` & `talking_equipment_sdk-0.0.8/talking_equipment/data/temperature/tests.py`

 * *Files identical despite different names*

### Comparing `talking_equipment_sdk-0.0.3/talking_equipment/data/vibration/tests.py` & `talking_equipment_sdk-0.0.8/talking_equipment/data/vibration/tests.py`

 * *Files identical despite different names*

### Comparing `talking_equipment_sdk-0.0.3/talking_equipment/talking_equipment_sdk.egg-info/SOURCES.txt` & `talking_equipment_sdk-0.0.8/talking_equipment/talking_equipment_sdk.egg-info/SOURCES.txt`
