# Comparing `tmp/datascope-experiments-0.0.89.tar.gz` & `tmp/datascope-experiments-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "datascope-experiments-0.0.89.tar", last modified: Wed May 22 23:35:11 2024, max compression
+gzip compressed data, was "datascope-experiments-0.0.9.tar", last modified: Sat Jan  7 11:55:37 2023, max compression
```

## Comparing `datascope-experiments-0.0.89.tar` & `datascope-experiments-0.0.9.tar`

### file list

```diff
@@ -1,65 +1,39 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.479742 datascope-experiments-0.0.89/
--rw-r--r--   0 runner    (1001) docker     (127)      109 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (127)      713 2024-05-22 23:35:11.479742 datascope-experiments-0.0.89/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      383 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.471742 datascope-experiments-0.0.89/datascope/
--rw-r--r--   0 runner    (1001) docker     (127)       65 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.471742 datascope-experiments-0.0.89/datascope/experiments/
--rw-r--r--   0 runner    (1001) docker     (127)      259 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)       63 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/__main__.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.471742 datascope-experiments-0.0.89/datascope/experiments/baselines/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.475742 datascope-experiments-0.0.89/datascope/experiments/baselines/influence/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/influence/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     2686 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/influence/dataset.py
--rw-r--r--   0 runner    (1001) docker     (127)    33529 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/influence/genericNeuralNet.py
--rw-r--r--   0 runner    (1001) docker     (127)     5508 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/influence/hessians.py
--rw-r--r--   0 runner    (1001) docker     (127)     1581 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/influence/importance.py
--rw-r--r--   0 runner    (1001) docker     (127)     6582 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/influence/logisticRegressionWithLBFGS.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.475742 datascope-experiments-0.0.89/datascope/experiments/baselines/matchingnet/
--rw-r--r--   0 runner    (1001) docker     (127)      205 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/matchingnet/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     3005 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/matchingnet/default_configs.py
--rw-r--r--   0 runner    (1001) docker     (127)     4710 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/matchingnet/few_shot_classifier.py
--rw-r--r--   0 runner    (1001) docker     (127)     7793 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/matchingnet/matchingnet_networks.py
--rw-r--r--   0 runner    (1001) docker     (127)     3373 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/matchingnet/predesigned_modules.py
--rw-r--r--   0 runner    (1001) docker     (127)     5654 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/matchingnet/resnet.py
--rw-r--r--   0 runner    (1001) docker     (127)      730 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/baselines/matchingnet/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.475742 datascope-experiments-0.0.89/datascope/experiments/bench/
--rw-r--r--   0 runner    (1001) docker     (127)      826 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/bench/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    64206 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/bench/base.py
--rw-r--r--   0 runner    (1001) docker     (127)     8310 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/bench/commands.py
--rw-r--r--   0 runner    (1001) docker     (127)     9493 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/bench/main.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.475742 datascope-experiments-0.0.89/datascope/experiments/datasets/
--rw-r--r--   0 runner    (1001) docker     (127)     1299 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/datasets/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    79148 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/datasets/base.py
--rw-r--r--   0 runner    (1001) docker     (127)     2241 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/datasets/cache.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.475742 datascope-experiments-0.0.89/datascope/experiments/pipelines/
--rw-r--r--   0 runner    (1001) docker     (127)     2303 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/pipelines/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    24665 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/pipelines/models.py
--rw-r--r--   0 runner    (1001) docker     (127)    23200 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/pipelines/pipelines.py
--rw-r--r--   0 runner    (1001) docker     (127)     1165 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/pipelines/postprocessors.py
--rw-r--r--   0 runner    (1001) docker     (127)     2154 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/pipelines/utility.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.475742 datascope-experiments-0.0.89/datascope/experiments/reports/
--rw-r--r--   0 runner    (1001) docker     (127)      159 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/reports/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    48488 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/reports/aggregate_plot.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.479742 datascope-experiments-0.0.89/datascope/experiments/scenarios/
--rw-r--r--   0 runner    (1001) docker     (127)      413 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/scenarios/__init__.py
--rwxr-xr-x   0 runner    (1001) docker     (127)     5252 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/scenarios/compute_time.py
--rwxr-xr-x   0 runner    (1001) docker     (127)    17082 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/scenarios/data_discard.py
--rwxr-xr-x   0 runner    (1001) docker     (127)    18245 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/scenarios/data_repair_scenario.py
--rwxr-xr-x   0 runner    (1001) docker     (127)    18480 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/scenarios/label_repair.py
--rw-r--r--   0 runner    (1001) docker     (127)     8088 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/scenarios/marginal_contribution.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.479742 datascope-experiments-0.0.89/datascope/experiments/utility/
--rw-r--r--   0 runner    (1001) docker     (127)      106 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/utility/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     2009 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/utility/files.py
--rw-r--r--   0 runner    (1001) docker     (127)       23 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/datascope/experiments/version.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 23:35:11.479742 datascope-experiments-0.0.89/datascope_experiments.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)      713 2024-05-22 23:35:11.000000 datascope-experiments-0.0.89/datascope_experiments.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     2236 2024-05-22 23:35:11.000000 datascope-experiments-0.0.89/datascope_experiments.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-22 23:35:11.000000 datascope-experiments-0.0.89/datascope_experiments.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       70 2024-05-22 23:35:11.000000 datascope-experiments-0.0.89/datascope_experiments.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (127)      217 2024-05-22 23:35:11.000000 datascope-experiments-0.0.89/datascope_experiments.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       10 2024-05-22 23:35:11.000000 datascope-experiments-0.0.89/datascope_experiments.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)      415 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/requirements.txt
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-22 23:35:11.479742 datascope-experiments-0.0.89/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     1105 2024-05-22 23:34:19.000000 datascope-experiments-0.0.89/setup.py
...
### Comparing `datascope-experiments-0.0.89/PKG-INFO` & `datascope-experiments-0.0.9/PKG-INFO`
...
### Comparing `datascope-experiments-0.0.89/datascope/experiments/bench/__init__.py` & `datascope-experiments-0.0.9/datascope/experiments/scenarios/__init__.py`
...
### Comparing `datascope-experiments-0.0.89/datascope/experiments/bench/base.py` & `datascope-experiments-0.0.9/datascope/experiments/scenarios/base.py`
...
### Comparing `datascope-experiments-0.0.89/datascope/experiments/reports/aggregate_plot.py` & `datascope-experiments-0.0.9/datascope/experiments/reports/aggregate_plot.py`
...
### Comparing `datascope-experiments-0.0.89/datascope/experiments/scenarios/data_discard.py` & `datascope-experiments-0.0.9/datascope/experiments/scenarios/data_discard.py`
...
### Comparing `datascope-experiments-0.0.89/datascope/experiments/scenarios/label_repair.py` & `datascope-experiments-0.0.9/datascope/experiments/scenarios/label_repair.py`
...
### Comparing `datascope-experiments-0.0.89/datascope_experiments.egg-info/PKG-INFO` & `datascope-experiments-0.0.9/datascope_experiments.egg-info/PKG-INFO`
...
### Comparing `datascope-experiments-0.0.89/setup.py` & `datascope-experiments-0.0.9/setup.py`
