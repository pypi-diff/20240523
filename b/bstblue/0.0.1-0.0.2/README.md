# Comparing `tmp/bstblue-0.0.1.tar.gz` & `tmp/bstblue-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "bstblue-0.0.1.tar", last modified: Thu May 23 14:16:17 2024, max compression
+gzip compressed data, was "bstblue-0.0.2.tar", last modified: Thu May 23 14:32:09 2024, max compression
```

## Comparing `bstblue-0.0.1.tar` & `bstblue-0.0.2.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxrwxrwx   0        0        0        0 2024-05-23 14:16:17.666600 bstblue-0.0.1/
--rw-rw-rw-   0        0        0        0 2024-05-23 13:29:33.000000 bstblue-0.0.1/LICENSE
--rw-rw-rw-   0        0        0      491 2024-05-23 14:16:17.666600 bstblue-0.0.1/PKG-INFO
--rw-rw-rw-   0        0        0      103 2024-05-23 13:32:24.000000 bstblue-0.0.1/pyproject.toml
--rw-rw-rw-   0        0        0      632 2024-05-23 14:16:17.673830 bstblue-0.0.1/setup.cfg
-drwxrwxrwx   0        0        0        0 2024-05-23 14:16:17.637446 bstblue-0.0.1/src/
-drwxrwxrwx   0        0        0        0 2024-05-23 14:16:17.648472 bstblue-0.0.1/src/bstblue/
--rw-rw-rw-   0        0        0        0 2024-05-23 13:48:24.000000 bstblue-0.0.1/src/bstblue/__init__.py
--rw-rw-rw-   0        0        0      157 2024-05-23 13:52:47.000000 bstblue-0.0.1/src/bstblue/main.py
-drwxrwxrwx   0        0        0        0 2024-05-23 14:16:17.666600 bstblue-0.0.1/src/bstblue.egg-info/
--rw-rw-rw-   0        0        0      491 2024-05-23 14:16:17.000000 bstblue-0.0.1/src/bstblue.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      216 2024-05-23 14:16:17.000000 bstblue-0.0.1/src/bstblue.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-23 14:16:17.000000 bstblue-0.0.1/src/bstblue.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        8 2024-05-23 14:16:17.000000 bstblue-0.0.1/src/bstblue.egg-info/top_level.txt
...
### Comparing `bstblue-0.0.1/setup.cfg` & `bstblue-0.0.2/setup.cfg`
