# Comparing `tmp/so_vits_svc_fork-4.2.7.tar.gz` & `tmp/so_vits_svc_fork-4.2.8.tar.gz`
...
### Comparing `so_vits_svc_fork-4.2.7/pyproject.toml` & `so_vits_svc_fork-4.2.8/pyproject.toml`
