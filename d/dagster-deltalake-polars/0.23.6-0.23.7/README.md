# Comparing `tmp/dagster-deltalake-polars-0.23.6.tar.gz` & `tmp/dagster-deltalake-polars-0.23.7.tar.gz`
...
## Comparing `dagster-deltalake-polars-0.23.6.tar` & `dagster-deltalake-polars-0.23.7.tar`
...
### Comparing `dagster-deltalake-polars-0.23.6/LICENSE` & `dagster-deltalake-polars-0.23.7/LICENSE`

 * *Files identical despite different names*

### Comparing `dagster-deltalake-polars-0.23.6/PKG-INFO` & `dagster-deltalake-polars-0.23.7/PKG-INFO`
...
### Comparing `dagster-deltalake-polars-0.23.6/dagster_deltalake_polars/deltalake_polars_type_handler.py` & `dagster-deltalake-polars-0.23.7/dagster_deltalake_polars/deltalake_polars_type_handler.py`

 * *Files identical despite different names*

### Comparing `dagster-deltalake-polars-0.23.6/dagster_deltalake_polars.egg-info/PKG-INFO` & `dagster-deltalake-polars-0.23.7/dagster_deltalake_polars.egg-info/PKG-INFO`
...
### Comparing `dagster-deltalake-polars-0.23.6/setup.py` & `dagster-deltalake-polars-0.23.7/setup.py`
