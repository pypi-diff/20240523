# Comparing `tmp/eth_gtd_cli-0.0.6.tar.gz` & `tmp/eth_gtd_cli-0.0.60.tar.gz`

## Comparing `eth_gtd_cli-0.0.6.tar` & `eth_gtd_cli-0.0.60.tar`
...
### Comparing `eth_gtd_cli-0.0.6/src/ETH_GTD_cli/helper.py` & `eth_gtd_cli-0.0.60/src/ETH_GTD_cli/helper.py`
...
### Comparing `eth_gtd_cli-0.0.6/LICENSE` & `eth_gtd_cli-0.0.60/LICENSE`

 * *Files identical despite different names*

### Comparing `eth_gtd_cli-0.0.6/pyproject.toml` & `eth_gtd_cli-0.0.60/pyproject.toml`
...
### Comparing `eth_gtd_cli-0.0.6/PKG-INFO` & `eth_gtd_cli-0.0.60/PKG-INFO`
