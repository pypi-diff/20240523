# Comparing `tmp/packmanager-0.0.0.tar.gz` & `tmp/packmanager-1.0.5.tar.gz`
...
## Comparing `packmanager-0.0.0.tar` & `packmanager-1.0.5.tar`
...
### Comparing `packmanager-0.0.0/packManager/setup.py` & `packmanager-1.0.5/setup.py`
