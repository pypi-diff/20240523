# Comparing `tmp/jupyter_nebulagraph-0.12.3.tar.gz` & `tmp/jupyter_nebulagraph-0.9.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "jupyter_nebulagraph-0.12.3.tar", last modified: Wed May 22 09:05:58 2024, max compression
+gzip compressed data, was "jupyter_nebulagraph-0.9.1.tar", last modified: Thu Apr  4 03:35:06 2024, max compression
```

## Comparing `jupyter_nebulagraph-0.12.3.tar` & `jupyter_nebulagraph-0.9.1.tar`

### file list

```diff
@@ -1,17 +1,15 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 09:05:58.658625 jupyter_nebulagraph-0.12.3/
--rw-r--r--   0 runner    (1001) docker     (127)      550 2024-05-22 09:05:47.000000 jupyter_nebulagraph-0.12.3/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)    10104 2024-05-22 09:05:58.658625 jupyter_nebulagraph-0.12.3/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     9328 2024-05-22 09:05:47.000000 jupyter_nebulagraph-0.12.3/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 09:05:58.658625 jupyter_nebulagraph-0.12.3/jupyter_nebulagraph.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)    10104 2024-05-22 09:05:58.000000 jupyter_nebulagraph-0.12.3/jupyter_nebulagraph.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      301 2024-05-22 09:05:58.000000 jupyter_nebulagraph-0.12.3/jupyter_nebulagraph.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-22 09:05:58.000000 jupyter_nebulagraph-0.12.3/jupyter_nebulagraph.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       65 2024-05-22 09:05:58.000000 jupyter_nebulagraph-0.12.3/jupyter_nebulagraph.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)        5 2024-05-22 09:05:58.000000 jupyter_nebulagraph-0.12.3/jupyter_nebulagraph.egg-info/top_level.txt
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 09:05:58.658625 jupyter_nebulagraph-0.12.3/ngql/
--rw-r--r--   0 runner    (1001) docker     (127)      111 2024-05-22 09:05:47.000000 jupyter_nebulagraph-0.12.3/ngql/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    26097 2024-05-22 09:05:47.000000 jupyter_nebulagraph-0.12.3/ngql/magic.py
--rw-r--r--   0 runner    (1001) docker     (127)    15443 2024-05-22 09:05:47.000000 jupyter_nebulagraph-0.12.3/ngql/ng_load.py
--rw-r--r--   0 runner    (1001) docker     (127)      471 2024-05-22 09:05:47.000000 jupyter_nebulagraph-0.12.3/ngql/types.py
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-22 09:05:58.662625 jupyter_nebulagraph-0.12.3/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     1038 2024-05-22 09:05:47.000000 jupyter_nebulagraph-0.12.3/setup.py
...
### Comparing `jupyter_nebulagraph-0.12.3/LICENSE` & `jupyter_nebulagraph-0.9.1/LICENSE`

 * *Files identical despite different names*

### Comparing `jupyter_nebulagraph-0.12.3/README.md` & `jupyter_nebulagraph-0.9.1/README.md`
...
### Comparing `jupyter_nebulagraph-0.12.3/ngql/magic.py` & `jupyter_nebulagraph-0.9.1/ngql/magic.py`
...
### Comparing `jupyter_nebulagraph-0.12.3/setup.py` & `jupyter_nebulagraph-0.9.1/setup.py`
