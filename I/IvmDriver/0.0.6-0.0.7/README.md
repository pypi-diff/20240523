# Comparing `tmp/ivmdriver-0.0.6.tar.gz` & `tmp/ivmdriver-0.0.7.tar.gz`
...
### Comparing `ivmdriver-0.0.6/IvmDriver/docs/DFT Matrix.pptx` & `ivmdriver-0.0.7/IvmDriver/docs/DFT Matrix.pptx`
